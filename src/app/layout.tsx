...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Er. Prince Sharma | MERN Stack Developer",
    description:
      "Portfolio of Er. Prince Sharma, a MERN Stack Developer creating modern, fast and scalable web applications.",
  ...
  twitter: {
    ...
    description:
      "Portfolio of Er. Prince Sharma, a MERN Stack Developer creating modern, fast and scalable web applications.",
    images: [
      "https://res.cloudinary.com/dfsg5ylsb/image/upload/w_1200,h_630,c_fill,r_max/v1771916315/Avatar_rmysea.webp",
    ], // Fallback
  },
};
