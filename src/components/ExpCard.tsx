...
const ExpCard = ({ item }: { item: ExperienceType }) => {
  return (
    <div className="relative group">
      ...
      <h2
        className="mb-2 w-fit rounded-md px-2 py-0.5 font-bold text-neutral-900 shadow-[var(--shadow-aceternity)] dark:text-neutral-100 group-hover:text-primary transition duration-300"
