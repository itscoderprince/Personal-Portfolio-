        ...
        <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 w-auto lg:hidden">
            <Dock className="items-center pb-2 bg-white/80 dark:bg-black/80 border border-neutral-200 dark:border-neutral-800 backdrop-blur-md shadow-xl gap-3 rounded-full">
                {navLinks.map((item, idx) => (
                    <DockIcon key={idx} className="h-10 w-10 bg-transparent dark:bg-transparent hover:bg-gray-100 dark:hover:bg-neutral-800 transition-colors border border-transparent hover:border-neutral-200 dark:hover:border-neutral-700">
                ...
                <DockIcon className="h-10 w-10 bg-transparent dark:bg-transparent hover:bg-gray-100 dark:hover:bg-neutral-800 transition-colors border border-transparent hover:border-neutral-200 dark:hover:border-neutral-700">
