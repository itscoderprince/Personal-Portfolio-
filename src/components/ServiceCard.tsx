...
const ServiceCard = ({ service }: { service: ServiceType }) => {
  return (
    <div className='flex items-start justify-between rounded-md border border-neutral-200 dark:border-neutral-700 p-5 sm:p-8 bg-white dark:bg-transparent hover:bg-neutral-50 dark:hover:bg-zinc-900 transition-all duration-300 hover:border-primary relative'>
      <div>
