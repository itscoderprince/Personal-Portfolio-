    ...
    >
      <div className="flex flex-col items-center gap-5">
        ...
        <div className="relative group w-full flex justify-center">
          <Image
            src="https://res.cloudinary.com/dfsg5ylsb/image/upload/v1780050031/xajtzgmubi1gnbr6zskg.jpg"
        ...
        <p className="text-center text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed px-2">
          Self-taught Full Stack Developer with a passion for building scalable{" "}
          <span className="text-neutral-900 dark:text-white font-medium">
            MERN
          </span>{" "}
          applications. Currently building at{" "}
          <a
            href="https://webitya.com"
            target="_blank"
            className="text-black dark:text-white font-medium hover:underline underline-offset-2"
          >
            Webitya
          </a>
          .
        ...
        <div className="w-full mx-auto">
          <PrimaryButton
            href="#contact"
            className="w-full py-2.5 h-auto text-base font-semibold tracking-wide shadow-md hover:scale-[1.02] active:scale-[0.98]"
          >
            Let's Work Together!
          </PrimaryButton>
        </div>
