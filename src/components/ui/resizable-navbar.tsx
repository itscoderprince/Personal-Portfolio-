  ...
  return (
    <motion.div
      animate={{
        ...
        width: visible ? "90%" : "100%", // Increased width to prevent overlap
        y: visible ? 10 : 0, // Slight drop down for effect
      ...
      className={
        cn(
          "relative z-[60] mx-auto hidden flex-row items-center justify-between self-start  bg-transparent px-4 py-3 lg:flex dark:bg-transparent transition-all duration-300",
          visible && "bg-white/80 dark:bg-neutral-950/80 shadow-md border border-neutral-200 dark:border-neutral-800 min-w-[600px]", // Min-width prevents squashing
          className,
        )}
    >
      {children}
