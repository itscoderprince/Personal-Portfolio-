  ...
  return (
    ...
    >
      ...
      <figure className="relative overflow-hidden aspect-video">
        <Image
          src={imgError ? "/images/uploads/lifecare.svg" : imgSrc}
          alt={title}
          fill
      ...
      <div className="p-2 pt-2">
        <div className="flex justify-between items-start mb-2">
          <h3 className="font-semibold text-md text-neutral-900 dark:text-neutral-100 truncate">
            {title}
          </h3>
        </div>
